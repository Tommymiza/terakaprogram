export const en_lang = {
  ...
  engage: {
    ...
    content: [
      ...
      "Corporate groves, Point-of-sale tree planting, Carbon offsetting, Low-impact products, custom integrations – we strengthen your value proposition on many levels",
